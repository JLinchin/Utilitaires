    ...
    <body  onload="calcul()">
        <div id="inputs">
            <div>
                ...
                <input type="number" name="valVitL" id="valVitL" value="0.25" oninput="calcul()"/>
            </div>

            <div>
                <label for="valVitT">de 100 t/h : </label>
                <input type="number" name="valVitT" id="valVitT" value="1.25" oninput="calcul()"/>
            </div>

           <div> 
                <label for="valDebit">Débit (en l/h) : </label>
                <input type="number" name="valDebit" id="valDebit" value="1000" oninput="calcul()"/>
